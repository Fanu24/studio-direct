...
try{
 for(const app of ['web','crawler']){
  const names=app==='web'?['BETTER_AUTH_SECRET','TURNSTILE_SECRET_KEY','STRIPE_SECRET_KEY','STRIPE_WEBHOOK_SECRET','GOOGLE_CLIENT_ID','GOOGLE_CLIENT_SECRET','PRODUCT_INTERNAL_SECRET','X_USER_ACCESS_TOKEN','LINKEDIN_ACCESS_TOKEN','LINKEDIN_AUTHOR_URN','LINKEDIN_VERSION','TELEGRAM_BOT_TOKEN','TELEGRAM_CHAT_ID']:['WEB3_CAREER_API_TOKEN','PRODUCT_INTERNAL_SECRET'];
