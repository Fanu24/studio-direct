...
export async function exportTalent(db:Database,recruiterId:string,filters:TalentFilters,after=''){
 ...
 const columns=['user_id','display_name','headline','location','experience_years','salary_min','languages','skills','website','email'];
