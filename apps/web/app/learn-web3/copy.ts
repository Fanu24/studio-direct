...
const LEARN_FORMAT_LEVEL_COPY: Record<string, LearnCopyEntry> = {
  ...
  interview: {
    ...
    paragraphs: [
      ...
      "Skip paid packs that promise to reverse-engineer unnamed companies. The honest dataset is this catalog. If a company listed a role here, the description is the study guide. If they did not list here, we cannot help you invent their process. We can still help you get fluent in the tag they would likely use.",
